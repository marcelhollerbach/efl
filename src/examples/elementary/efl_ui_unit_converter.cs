...
public class Example
{
    ...
    {
        Efl.Ui.PopupAlert popup = new Efl.Ui.PopupAlert(win);
        Efl.Ui.Text popup_text = new Efl.Ui.Text(popup);
        popup_text.SetText($"Error: {message}");
        popup.SetContent(popup_text);
        popup.SetVisible(true);
        popup.SetButton(Efl.Ui.PopupAlertButton.Positive, "Ok", null);
        popup.SetSize(new Eina.Size2D(150, 30));
        popup.ButtonClickedEvt += (object sender, Efl.Ui.PopupAlert.ButtonClickedEvt_Args e) => {
