...
struct klass
{
     ...
     if(class_type != "class")
       {
         ...
         std::string new_modifier = root ? "" : "new ";

         if (!as_generator
            (scope_tab << "///<summary>Pointer to the native class description.</summary>\n"
             << scope_tab << "public " << new_modifier << "System.IntPtr raw_klass {\n"
             ...
             << scope_tab << "internal " << new_modifier << "void Dispose(bool disposing)\n"
             << scope_tab << "{\n"
             ...
             << scope_tab << "}\n"
             << scope_tab << "///<summary>Releases the underlying native instance.</summary>\n"
             << scope_tab << "public " << new_modifier << "void Dispose()\n"
             << scope_tab << "{\n"
   ...
   bool generate_constructors(OutputIterator sink, attributes::klass_def const& cls, Context const& context) const
   {
     ...
     if(!as_generator(
                ...
                << scope_tab << "///<summary>Pointer to the native class description.</summary>\n"
                << scope_tab << "public " << (root ? "virtual " : "override " ) << "System.IntPtr raw_klass {\n"
